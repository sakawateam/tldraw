...
import { TDSnapshot, ShapesWithProp, TDShape, TDBinding, TDPage, TldrawCommand } from '../types';
...
export declare class TLDR {
    ...
    static updateBindings(data: TDSnapshot, id: string, beforeShapes: Record<string, Partial<TDShape>> | undefined, afterShapes: Record<string, Partial<TDShape>> | undefined, pageId: string): TDSnapshot;
    ...
    static onBindingChange<T extends TDShape>(shape: T, binding: TDBinding, otherShape: TDShape): T;
