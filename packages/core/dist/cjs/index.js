...
var import_mobx_react_lite21 = __toModule(require("mobx-react-lite"));
var React44 = __toModule(require("react"));

// src/components/Canvas/Canvas.tsx
var import_mobx_react_lite20 = __toModule(require("mobx-react-lite"));
...
var import_react = __toModule(require("@use-gesture/react"));
  ...
  (0, import_react.useGesture)({
    onWheel: ({ delta, event: e }) => {
      ...
      if (inputs2.isPinching)
        return;
      if (import_vec.Vec.isEqual(delta, [0, 0]))
        return;
    ...
    onPinch: ({ origin, offset, event }) => {
      ...
      const trueDelta = import_vec.Vec.sub(info.delta, rDelta.current);
...
var _Utils = class {
  ...
  static getRectangleSides(point, size, rotation = 0) {
    ...
    const tl = import_vec2.Vec.rotWith(point, center, rotation);
    const tr = import_vec2.Vec.rotWith(import_vec2.Vec.add(point, [size[0], 0]), center, rotation);
    const br = import_vec2.Vec.rotWith(import_vec2.Vec.add(point, size), center, rotation);
    const bl = import_vec2.Vec.rotWith(import_vec2.Vec.add(point, [0, size[1]]), center, rotation);
    return [
      ["top", [tl, tr]],
      ["right", [tr, br]],
      ["bottom", [br, bl]],
  ...
  static getSweep(C, A, B) {
    return _Utils.angleDelta(import_vec2.Vec.angle(C, A), import_vec2.Vec.angle(C, B));
  }
  ...
  static getSweepFlag(A, B, C) {
    const angleAC = import_vec2.Vec.angle(A, C);
    const angleAB = import_vec2.Vec.angle(A, B);
    const angleCAB = (angleAB - angleAC + 3 * Math.PI) % (2 * Math.PI) - Math.PI;
    return angleCAB > 0 ? 0 : 1;
  }
  static getLargeArcFlag(A, C, P) {
    const anglePA = import_vec2.Vec.angle(P, A);
    const anglePC = import_vec2.Vec.angle(P, C);
  ...
  static pointInCircle(A, C, r) {
    return import_vec2.Vec.dist(A, C) <= r;
  }
  static pointInEllipse(A, C, rx, ry, rotation = 0) {
    rotation = rotation || 0;
    const cos = Math.cos(rotation);
    const sin = Math.sin(rotation);
    const delta = import_vec2.Vec.sub(A, C);
  ...
  static pointInPolygon(p, points) {
    ...
    points.forEach((a, i) => {
      ...
      if (a[1] <= p[1]) {
        if (b[1] > p[1] && import_vec2.Vec.cross(a, b, p) > 0) {
          wn += 1;
        }
      } else if (b[1] <= p[1] && import_vec2.Vec.cross(a, b, p) < 0) {
        wn -= 1;
      }
    });
    return wn !== 0;
  ...
  static pointInPolyline(A, points, distance = 3) {
    for (let i = 1; i < points.length; i++) {
      if (import_vec2.Vec.distanceToLineSegment(points[i - 1], points[i], A) < distance) {
        return true;
      }
    }
    return false;
  ...
  static getBoundsFromPoints(points, rotation = 0) {
    ...
    if (rotation !== 0) {
      return _Utils.getBoundsFromPoints(points.map((pt) => import_vec2.Vec.rotWith(pt, [(minX + maxX) / 2, (minY + maxY) / 2], rotation)));
    }
    return {
      minX,
      minY,
  ...
  static rotateBounds(bounds, center, rotation) {
    const [minX, minY] = import_vec2.Vec.rotWith([bounds.minX, bounds.minY], center, rotation);
    const [maxX, maxY] = import_vec2.Vec.rotWith([bounds.maxX, bounds.maxY], center, rotation);
    return {
      minX,
      minY,
      maxX,
  ...
  static getRotatedCorners(b, rotation = 0) {
    ...
    return [
      ...
      [b.maxX, b.maxY],
      [b.minX, b.maxY]
    ].map((point) => import_vec2.Vec.rotWith(point, center, rotation));
  }
  static getTransformedBoundingBox(bounds, handle, delta, rotation = 0, isAspectRatioLocked = false) {
    ...
    const [dx, dy] = import_vec2.Vec.rot(delta, -rotation);
    switch (handle) {
    ...
    if (rotation % (Math.PI * 2) !== 0) {
      let cv = [0, 0];
      const c0 = import_vec2.Vec.med([ax0, ay0], [ax1, ay1]);
      const c1 = import_vec2.Vec.med([bx0, by0], [bx1, by1]);
      switch (handle) {
        case TLBoundsCorner.TopLeft: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith([bx1, by1], c1, rotation), import_vec2.Vec.rotWith([ax1, ay1], c0, rotation));
          break;
        }
        case TLBoundsCorner.TopRight: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith([bx0, by1], c1, rotation), import_vec2.Vec.rotWith([ax0, ay1], c0, rotation));
          break;
        }
        case TLBoundsCorner.BottomRight: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith([bx0, by0], c1, rotation), import_vec2.Vec.rotWith([ax0, ay0], c0, rotation));
          break;
        }
        case TLBoundsCorner.BottomLeft: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith([bx1, by0], c1, rotation), import_vec2.Vec.rotWith([ax1, ay0], c0, rotation));
          break;
        }
        case TLBoundsEdge.Top: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith(import_vec2.Vec.med([bx0, by1], [bx1, by1]), c1, rotation), import_vec2.Vec.rotWith(import_vec2.Vec.med([ax0, ay1], [ax1, ay1]), c0, rotation));
          break;
        }
        case TLBoundsEdge.Left: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith(import_vec2.Vec.med([bx1, by0], [bx1, by1]), c1, rotation), import_vec2.Vec.rotWith(import_vec2.Vec.med([ax1, ay0], [ax1, ay1]), c0, rotation));
          break;
        }
        case TLBoundsEdge.Bottom: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith(import_vec2.Vec.med([bx0, by0], [bx1, by0]), c1, rotation), import_vec2.Vec.rotWith(import_vec2.Vec.med([ax0, ay0], [ax1, ay0]), c0, rotation));
          break;
        }
        case TLBoundsEdge.Right: {
          cv = import_vec2.Vec.sub(import_vec2.Vec.rotWith(import_vec2.Vec.med([bx0, by0], [bx0, by1]), c1, rotation), import_vec2.Vec.rotWith(import_vec2.Vec.med([ax0, ay0], [ax0, ay1]), c0, rotation));
          break;
        }
      }
      ;
      [bx0, by0] = import_vec2.Vec.sub([bx0, by0], cv);
      [bx1, by1] = import_vec2.Vec.sub([bx1, by1], cv);
    }
    if (bx1 < bx0) {
      ;
      [bx1, bx0] = [bx0, bx1];
  ...
  static getRotatedSize(size, rotation) {
    const center = import_vec2.Vec.div(size, 2);
    const points = [[0, 0], [size[0], 0], size, [0, size[1]]].map((point) => import_vec2.Vec.rotWith(point, center, rotation));
  ...
  static getSvgPathFromStroke(points, closed = true) {
    ...
    return points.reduce((acc, point, i, arr) => {
      if (i === max) {
        ...
        acc.push(point, import_vec2.Vec.med(point, arr[i + 1]));
      }
      return acc;
...
function useShapeTree(page, pageState, meta) {
  ...
  const rShapesIdsToRender = React5.useRef(new Set());
  const rShapesToRender = React5.useRef(new Set());
...
function useBoundsEvents() {
  const { callbacks, inputs: inputs2 } = useTLContext();
  const onPointerDown = React12.useCallback((e) => {
    var _a, _b, _c, _d;
    if (!inputs2.pointerIsValid(e))
      return;
    if (e.button === 2) {
  ...
  const onPointerUp = React12.useCallback((e) => {
    var _a, _b, _c, _d;
    if (e.button !== 0)
      return;
    inputs2.activePointer = void 0;
  ...
  const onPointerMove = React12.useCallback((e) => {
    var _a, _b;
    if (!inputs2.pointerIsValid(e))
      return;
    if (e.currentTarget.hasPointerCapture(e.pointerId)) {
...
var ErrorFallback = React15.memo(function ErrorFallback2({
  error,
  resetErrorBoundary
}) {
  const { callbacks } = useTLContext();
...
var ErrorBoundary = class extends React16.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    if (error !== null) {
      ...
      if (React16.isValidElement(fallback)) {
        return fallback;
      } else if (typeof fallbackRender === "function") {
        return fallbackRender(props);
      } else if (FallbackComponent) {
        return /* @__PURE__ */ React16.createElement(FallbackComponent, __spreadValues({}, props));
      } else {
...
var import_mobx_react_lite2 = __toModule(require("mobx-react-lite"));

// src/components/Container/Container.tsx
var import_mobx_react_lite = __toModule(require("mobx-react-lite"));
...
var Brush = (0, import_mobx_react_lite2.observer)(function Brush2({ brush }) {
...
var import_mobx_react_lite17 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite3 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite4 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite5 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite6 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite7 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite8 = __toModule(require("mobx-react-lite"));
...
// src/components/Bounds/Bounds.tsx
var import_mobx_react_lite9 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite10 = __toModule(require("mobx-react-lite"));
var React28 = __toModule(require("react"));
var BoundsBg = (0, import_mobx_react_lite10.observer)(function BoundsBg2({
  bounds,
  rotation,
  isHidden
}) {
...
var import_mobx_react_lite12 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite11 = __toModule(require("mobx-react-lite"));
...
// src/components/Handles/Handles.tsx
var Handles = (0, import_mobx_react_lite12.observer)(function Handles2({
  shape,
  zoom
}) {
  ...
  const handlesToShow = Object.values(shape.handles).reduce((acc, cur) => {
    const point = import_vec4.Vec.add(cur.point, shape.point);
    if (!prev || import_vec4.Vec.dist(point, prev) * zoom >= 32) {
      acc.push(cur);
      prev = point;
    }
    return acc;
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, handlesToShow.map((handle) => /* @__PURE__ */ React30.createElement(Handle, {
    ...
    id: handle.id,
    point: import_vec4.Vec.add(handle.point, shape.point)
  })));
});

// src/components/Shape/ShapeNode.tsx
var import_mobx_react_lite15 = __toModule(require("mobx-react-lite"));
var React33 = __toModule(require("react"));

// src/components/Shape/Shape.tsx
var import_mobx_react_lite14 = __toModule(require("mobx-react-lite"));
var React32 = __toModule(require("react"));

// src/components/Shape/RenderedShape.tsx
var import_mobx_react_lite13 = __toModule(require("mobx-react-lite"));
...
var import_mobx_react_lite16 = __toModule(require("mobx-react-lite"));
...
var Page = (0, import_mobx_react_lite17.observer)(function _Page({
  ...
  return /* @__PURE__ */ React35.createElement(React35.Fragment, null, bounds && /* @__PURE__ */ React35.createElement(BoundsBg, {
    ...
    key: node.shape.id,
    utils: shapeUtils
  }, node))), !hideIndicators && selectedShapes.map((shape) => /* @__PURE__ */ React35.createElement(ShapeIndicator, {
    key: "selected_" + shape.id,
    shape,
    meta,
    isSelected: true
  })), !hideIndicators && hoveredId && /* @__PURE__ */ React35.createElement(ShapeIndicator, {
...
function User({ user }) {
  const rUser = React36.useRef(null);
...
var Inputs = class {
  ...
  touchMove(e, target) {
    ...
    const delta = (prev == null ? void 0 : prev.point) ? import_vec5.Vec.sub(point, prev.point) : [0, 0];
  ...
  isDoubleClick() {
    ...
    const isDoubleClick = Date.now() - this.pointerUpTime < DOUBLE_CLICK_DURATION && import_vec5.Vec.dist(origin, point) < 4;
    if (isDoubleClick)
      this.activePointer = void 0;
  ...
  pinch(point, origin) {
    ...
    const delta = import_vec5.Vec.sub(origin, point);
    const info = {
      pointerId: 0,
      target: "pinch",
      origin,
      delta,
      point: import_vec5.Vec.sub(import_vec5.Vec.toFixed(point), [this.bounds.minX, this.bounds.minY]),
      pressure: 0.5,
      shiftKey,
      ctrlKey,
      metaKey: Utils.isDarwin() ? metaKey : ctrlKey,
...
var import_mobx_react_lite18 = __toModule(require("mobx-react-lite"));
...
function Grid({ grid, camera }) {
  ...
  })), STEPS.map((_14, i) => /* @__PURE__ */ React41.createElement("rect", {
    key: `grid-rect-${i}`,
    width: "100%",
    height: "100%",
    fill: `url(#grid-${i})`
...
var import_mobx_react_lite19 = __toModule(require("mobx-react-lite"));
...
var Canvas = (0, import_mobx_react_lite20.observer)(function _Canvas({
  id,
  page,
  pageState,
  snapLines,
  ...
  return /* @__PURE__ */ React43.createElement("div", {
    ...
    ref: rContainer
  }, /* @__PURE__ */ React43.createElement("div", __spreadValues({
    id: "canvas",
    className: "tl-absolute tl-canvas",
    ref: rCanvas
  }, events), /* @__PURE__ */ React43.createElement(ErrorBoundary, {
    FallbackComponent: ErrorFallback,
    onReset: resetError
  }, !hideGrid && grid && /* @__PURE__ */ React43.createElement(Grid, {
    grid,
...
// src/components/Renderer/Renderer.tsx
var Renderer = (0, import_mobx_react_lite21.observer)(function _Renderer(_a) {
  var _b = _a, {
    id = "tl",
    shapeUtils,
    page,
...
var import_mobx_react_lite22 = __toModule(require("mobx-react-lite"));
var React45 = __toModule(require("react"));
var HTMLContainer = React45.forwardRef(function HTMLContainer2(_a, ref) {
  var _b = _a, { children, className = "" } = _b, rest = __objRest(_b, ["children", "className"]);
  return /* @__PURE__ */ React45.createElement(import_mobx_react_lite22.Observer, null, () => /* @__PURE__ */ React45.createElement("div", __spreadValues({
    ref,
...
var TLShapeUtil = class {
  constructor() {
    ...
    __publicField(this, "hitTestBounds", (shape, bounds) => {
      ...
      return corners.every((point) => utils_default.pointInBounds(point, bounds)) || (0, import_intersect.intersectPolylineBounds)(corners, bounds).length > 0;
    });
